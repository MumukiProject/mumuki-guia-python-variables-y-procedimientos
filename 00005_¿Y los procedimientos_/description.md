En el ejercicio anterior, construiste una `function` que se ejecutaba con el sólo fin de print por pantalla. Y por ello, tuvimos que devolver un valor cualquiera. ¿No te huele mal?
